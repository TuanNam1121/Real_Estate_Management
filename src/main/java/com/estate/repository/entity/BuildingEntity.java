...
public class BuildingEntity {
	...
	private String serviceFee, carFee, motorbikeFee, waterFee, electricityFee, deposit, payment,
	rentTime, decorationTime, brokerageFee, note, linkOfBuilding, map, image;
